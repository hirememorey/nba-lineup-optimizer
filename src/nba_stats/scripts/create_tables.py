...
def create_possessions_table(conn: sqlite3.Connection) -> None:
    """Create the Possessions table to store play-by-play data."""
    cursor = conn.cursor()
    cursor.execute("""
    ...
    """)
    logger.info("Possessions table checked/created.")
